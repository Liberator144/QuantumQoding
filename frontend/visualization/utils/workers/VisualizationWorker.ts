 ...
 */
ctx.onmessage = (event: MessageEvent<WorkerMessageData>) => {
 ...
 */
function computeGeometry(data: any): any {
 ...
 */
function computeSphereGeometry(data: any): any {
 ...
 */
function computeGalaxyGeometry(data: any): any {
 ...
 */
function computeNebulaGeometry(data: any): any {
 ...
 */
function computeStarSystemGeometry(data: any): any {
 ...
 */
function computeCustomGeometry(
  vertices: number[],
  indices: number[],
  normals: number[],
  uvs: number[]
 ...
 */
function processParticles(data: any): any {
 ...
 */
function calculatePhysics(data: any): any {
 ...
 */
function generateStarField(data: any): any {
 ...
 * @returns Nebula data
 */
function generateNebula(data: any): any {
 ...
 * @returns RGB color
 */
function temperatureToRGB(temperature: number): { r: number; g: number; b: number } {
