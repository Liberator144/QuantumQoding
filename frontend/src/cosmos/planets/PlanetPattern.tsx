 ...
 * Migrated from: PlanetPattern.js
 * @version 2.0.0
 */
...
const PlanetPattern = ({ style, color, seed }) => {
    ...
    if (style === 'gas') {
        ...
        <div className="absolute inset-0" style={{
          ...
          {/* Cloud bands */}
          {[...Array(6)].map((_, i) => (<div key={i} className="absolute w-full" style={{
    ...
    if (style === 'ice') {
        ...
        <div className="absolute inset-0" style={{
          ...
          {[...Array(6)].map((_, i) => {
                ...
                return (<div key={`crystal-${i}`} className="absolute" style={{
                        width: `${rand * 15 + 5}%`,
                        height: `${rand * 15 + 5}%`,
        ...
        <div className="absolute inset-0 opacity-30 group-hover:opacity-70 transition-opacity duration-500">
          {[...Array(5)].map((_, i) => {
                ...
                return (<motion.div key={`mist-${i}`} className="absolute rounded-full" style={{
                        width: `${rand * 60 + 40}%`,
                        height: `${rand * 20 + 20}%`,
    ...
    if (style === 'oceanic') {
        ...
        <div className="absolute inset-0" style={{
          ...
          {[...Array(8)].map((_, i) => {
                ...
                const delay = rand * 2;
                return (<motion.div key={i} className="absolute w-full" style={{
                        height: `${height}%`,
                        top: `${top}%`,
          ...
          {[...Array(4)].map((_, i) => {
                ...
                return (<motion.div key={i} className="absolute" style={{
                        width: `${width}%`,
                        height: `${height}%`,
                        left: `${left}%`,
                        top: `${top}%`,
          ...
          <div className="absolute inset-0 opacity-20 group-hover:opacity-50 transition-opacity duration-500">
            {[...Array(6)].map((_, i) => {
                ...
                return (<motion.div key={`cloud-${i}`} className="absolute rounded-full blur-md" style={{
                        width: `${width}%`,
                        height: `${height}%`,
                        left: `${left}%`,
                        top: `${top}%`,
        ...
        <div className="absolute inset-0" style={{
          ...
          <div className="absolute inset-0 opacity-40 group-hover:opacity-80 transition-opacity duration-300">
            {[...Array(8)].map((_, i) => {
                ...
                return (<motion.div key={`particle-${i}`} className="absolute rounded-full" style={{
                        width: `${size}px`,
                        height: `${size}px`,
                        left: `${startLeft}%`,
                        top: `${startTop}%`,
