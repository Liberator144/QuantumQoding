...
const QuantumSphere = () => {
    ...
    return (_jsxs("div", { className: "relative w-full h-[100vh] overflow-hidden bg-[#050714]", children: [_jsx("div", { className: "absolute inset-0", children: _jsx(SparklesCore, { id: "quantum-sparkles", background: "transparent", particleColor: "#ffffff", particleDensity: 100, speed: 1, minSize: 0.5, maxSize: 1 }) }), _jsx(AnimatePresence, { children: transitionState !== 'none' && (_jsxs(motion.div, { className: "absolute inset-0 z-50 pointer-events-none", initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: { duration: 1.5 }, children: [_jsx(motion.div, { className: "absolute inset-0 backdrop-blur-sm", initial: { opacity: 0 }, animate: { opacity: 0.8 }, exit: { opacity: 0 }, style: { backgroundColor: 'rgba(0, 0, 0, 0.5)' } }), _jsxs("div", { className: "absolute inset-0 flex items-center justify-center", children: [_jsx(motion.div, { className: "absolute rounded-full", initial: {
                                        ...
                                        duration: 1.8,
                                        ease: "easeInOut"
                                    } }), _jsxs(motion.div, { className: "relative flex items-center justify-center", initial: {
                                        ...
                                        duration: 1.5,
                                        ease: "easeInOut"
                                    }, children: [[...Array(8)].map((_, i) => (_jsx(motion.div, { className: "absolute border-2 rounded-full border-opacity-60", style: {
                                                width: `${(i + 1) * 40}px`,
                                                height: `${(i + 1) * 40}px`,
                                                ...
                                                ease: "linear",
                                                repeatType: "loop"
                                            } }, `ring-${selectedStar?.name ?? 'default'}-${i}`))), _jsxs("div", { className: "relative w-40 h-40", children: [_jsx(motion.div, { className: "absolute inset-0 rounded-full", style: {
                                                        ...
                                                        repeat: Infinity,
                                                        repeatType: "reverse"
                                                    } }), [...Array(12)].map((_, i) => (_jsx(motion.div, { className: "absolute", style: {
                                                        width: '150%',
                                                        height: '2px',
                                                        top: '50%',
                                                        left: '50%',
                                                        ...
                                                        repeat: Infinity,
                                                        repeatType: "reverse"
                                                    } }, `flare-${selectedStar?.name ?? 'default'}-${i}`)))] })] }), [...Array(80)].map((_, i) => (_jsx(motion.div, { className: "absolute rounded-full", style: {
                                    ...
                                    } }, `outerparticle-${i}-${selectedStar?.name ?? 'default'}`))), [...Array(100)].map((_, i) => {
                                ...
                                })] }), _jsx(motion.div, { className: "absolute inset-0 pointer-events-none", initial: { scale: 1, rotate: 0, x: 0, y: 0 }, animate: transitionState === 'entering'
                                ? {
                            ...
                            } }), _jsx(motion.div, { className: "absolute inset-0 pointer-events-none", initial: { opacity: 0 }, animate: {
                                opacity: [0, 0.3, 0],
                            }, transition: {
                                duration: 1.5,
                                ease: "easeInOut",
                                times: [0, 0.5, 1]
                            }, style: { backgroundColor: "black" } })] })) }), transitionState !== 'none' && (_jsxs(_Fragment, { children: [_jsx("audio", { src: `/audio/${transitionState === 'entering' ? 'wormhole-enter.mp3' : 'wormhole-exit.mp3'}`, autoPlay: true, children: _jsx("track", { kind: "captions" }) }), _jsx("audio", { src: `/audio/${transitionState === 'entering' ? 'quantum-surge.mp3' : 'quantum-collapse.mp3'}`, autoPlay: true, children: _jsx("track", { kind: "captions" }) }), _jsx("audio", { src: "/audio/space-ambience.mp3", autoPlay: true, loop: true, children: _jsx("track", { kind: "captions" }) })] })), currentView === 'hub' && (_jsxs(motion.div, { className: "relative w-full h-full", style: {
                    scale,
                    ...
                    setScale(newScale);
                }, children: [['inner', 'middle', 'outer'].map((orbit, i) => (_jsx("div", { className: "absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2", children: _jsx("div", { className: "rounded-full border border-[#1a2040]/30 relative", style: {
                                width: `${(i + 1) * 400}px`,
                                height: `${(i + 1) * 400}px`,
                                    ...
                                    animation: `spin ${(i + 1) * 100}s linear infinite`,
                                } }) }) }, orbit))), _jsx("div", { className: "absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2", children: _jsxs("div", { className: "relative w-[400px] h-[400px]", children: [_jsx("div", { className: "absolute inset-0 rounded-full overflow-hidden shadow-[0_0_100px_rgba(147,51,234,0.3)]", children: _jsxs("div", { className: "absolute inset-0 bg-gradient-radial from-[#2d1b4e] via-[#6e3bc4] to-[#b83280] animate-pulse", children: [_jsx("div", { className: "absolute inset-0 opacity-30", children: [...Array(12)].map((_, i) => {
                                                    const latticeKey = `lattice-${i * 30}`;
                                                    return (_jsx("div", { className: "absolute w-full h-full", style: {
                                                ...
                                                return (_jsx(motion.div, { className: "absolute top-1/2 left-1/2 w-full h-[2px] origin-left", style: {
                                            ...
                                            }), [...Array(30)].map((_, i) => (_jsx(motion.div, { className: "absolute rounded-full bg-cyan-400", style: {
                                                    ...
                                                    ease: 'easeOut',
                                                    delay: Math.random() * 2,
                                                } }, `databurst-${i}`))), [...Array(8)].map((_, i) => {
                                                const streamKey = `stream-${i * 45}`;
                                                return (_jsx(motion.div, { className: "absolute top-1/2 left-1/2 h-full w-[1px] origin-center", style: {
                                            ...
                                            })] }) }), _jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsx(QuantumPortalCore, { isLoggedIn: false, userName: "", onLogin: (username, password) => {
                                            console.log('Login attempt:', username, password);
                                        } }) }), _jsx("div", { className: "absolute inset-[-25%] rounded-full", children: _jsx("div", { className: "w-full h-full opacity-30", style: {
                                            background: 'radial-gradient(circle, rgba(236, 72, 153, 0.4) 0%, transparent 70%)',
                                            filter: 'blur(50px)',
                                        } }) })] }) }), orbitNodes.map((node) => (_jsx(Star, { node: node, isHovered: hoveredStar === node.name, onHover: handleStarHover, onNavigate: navigateToStarSystem }, `star-${node.name}`)))] })), currentView === 'star-system' && selectedStar && (_jsx(StarSystemView, { star: selectedStar, onReturnToHub: returnToHub })), _jsxs("div", { className: "absolute flex gap-2 bottom-4 right-4", children: [_jsx("button", { onClick: () => setScale(Math.min(scale + 0.1, 2)), className: "p-2 text-white rounded-full bg-white/10 hover:bg-white/20", children: "+" }), _jsx("button", { onClick: () => setScale(Math.max(scale - 0.1, 0.5)), className: "p-2 text-white rounded-full bg-white/10 hover:bg-white/20", children: "-" })] })] }));
};
