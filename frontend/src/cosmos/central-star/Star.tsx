...
import type { OrbitNode } from './QuantumSphere';

type StarProps = {
  node: OrbitNode;
  isHovered: boolean;
  onHover: (name: string | null) => void;
  onNavigate: (star: OrbitNode) => void;
};
  ...
  return (
    ...
    >
      ...
      <div className="absolute mt-2 -translate-x-1/2 top-full left-1/2">
        ...
        >
          <div
            className={`px-3 py-1.5 rounded-full backdrop-blur-sm transition-all duration-300
                     ${isHovered ? 'bg-black/50 border-opacity-100' : 'bg-black/20 border-opacity-50'}`}
            style={{
              borderWidth: '1px',
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="absolute z-30 transform -translate-x-1/2 left-1/2"
            style={{
              top: 'calc(100% + 2rem)',
              width: '280px',
            }}
          >
            <div
              className="relative p-4 border rounded-lg backdrop-blur-md"
              style={{
            ...
            >
              ...
              >
                ...
                <p
                  className="mb-3 text-sm leading-relaxed text-white/90"
                  style={{
                ...
                <div className="mt-4 text-center">
                  <motion.div
                    className="inline-block text-xs px-3 py-1.5 rounded-full cursor-pointer"
                    style={{
              ...
              {/* Connecting line */}
              <motion.div
                className="absolute w-px origin-bottom left-1/2 -top-8"
                initial={{
                  scaleY: 0,
                }}
                animate={{
