  ...
  async load(collection) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = event => {
          this.log(
            `Error loading data from IndexedDB for collection ${collection}: ${event.target.error.message}`
          );
          reject(event.target.error);
        };
  ...
  async save(collection, data) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = event => {
          this.log(
            `Error saving data to IndexedDB for collection ${collection}: ${event.target.error.message}`
          );
          reject(event.target.error);
        };
  ...
  async remove(collection) {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = event => {
          this.log(
            `Error removing data from IndexedDB for collection ${collection}: ${event.target.error.message}`
          );
          reject(event.target.error);
        };
