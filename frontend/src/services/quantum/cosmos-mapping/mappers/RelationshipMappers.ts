 ...
 */
export class ParentChildRelationshipMapper implements RelationshipMapper {
  /** Mapper name */
  name = 'ParentChildRelationshipMapper';
  
  /** Supported relationship types */
  supportedRelationshipTypes = [RelationshipType.PARENT_CHILD];
 ...
 */
export class ReferenceRelationshipMapper implements RelationshipMapper {
  /** Mapper name */
  name = 'ReferenceRelationshipMapper';
  
  /** Supported relationship types */
  supportedRelationshipTypes = [RelationshipType.REFERENCE];
 ...
 */
export class OwnershipRelationshipMapper implements RelationshipMapper {
  /** Mapper name */
  name = 'OwnershipRelationshipMapper';
  
  /** Supported relationship types */
  supportedRelationshipTypes = [RelationshipType.OWNERSHIP];
 ...
 */
export class CreationRelationshipMapper implements RelationshipMapper {
  /** Mapper name */
  name = 'CreationRelationshipMapper';
  
  /** Supported relationship types */
  supportedRelationshipTypes = [RelationshipType.CREATION];
