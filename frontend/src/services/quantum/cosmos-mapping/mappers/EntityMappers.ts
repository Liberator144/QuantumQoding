 ...
 */
export class RepositoryEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'RepositoryEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.REPOSITORY];
   ...
   */
  mapEntityToCosmicObject(entity: Entity, options: MappingOptions = {}): CosmicObject {
    ...
    const features: CosmicObjectFeature[] = [];
 ...
 * Issue entity mapper
 */
export class IssueEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'IssueEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.ISSUE];
 ...
 */
export class PullRequestEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'PullRequestEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.PULL_REQUEST];
 ...
 * User entity mapper
 */
export class UserEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'UserEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.USER];
 ...
 */
export class DatabaseEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'DatabaseEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.DATABASE];
 ...
 * Table entity mapper
 */
export class TableEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'TableEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.TABLE];
 ...
 */
export class RecordEntityMapper implements EntityMapper {
  /** Mapper name */
  name = 'RecordEntityMapper';
  
  /** Supported entity types */
  supportedEntityTypes = [EntityType.RECORD, EntityType.DOCUMENT];
