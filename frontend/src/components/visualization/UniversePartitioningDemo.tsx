 ...
 * Universe Partitioning Demo Component
 */
const UniversePartitioningDemo = ({ width = 800, height = 600, sectorSize = 200, enableSectorTransitions = true, debugMode = false, }) => {
    // Refs
    ...
    const universePartitionerRef = useRef(null);
    // State
    const [fps, setFps] = useState(0);
    const [activeSectors, setActiveSectors] = useState(0);
    const [totalSectors, setTotalSectors] = useState(0);
    const [currentSectorType, setCurrentSectorType] = useState(null);
    // Initialize scene
    useEffect(() => {
        ...
        universePartitionerRef.current = new UniversePartitioner(scene, camera, {
            sectorSize,
