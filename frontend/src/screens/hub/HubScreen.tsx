...
/**
 * Hub screen component - Central navigation hub for QuantumQonnect
...
const HubScreen: React.FC = () => {
    ...
    return (
        <div className="relative flex items-center justify-center w-full h-full overflow-hidden bg-[#050714]">
            {/* Background stars */}
            ...
            >
                <h1 className="text-4xl font-bold text-white">QuantumQonnect</h1>
