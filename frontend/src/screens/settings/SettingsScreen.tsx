  ...
  return (
    <div className="flex items-center justify-center w-full h-full bg-gray-900">
      ...
      >
        ...
        {success && (
          <div className="p-3 mb-4 text-sm text-green-300 bg-green-900 rounded-md">
            {success}
          </div>
        )}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    id="dimensionalEffects"
                    name="dimensionalEffects"
                    type="checkbox"
                    checked={settings.dimensionalEffects}
                    onChange={(e) => handleSettingChange('dimensionalEffects', e.target.checked)}
                    className="w-4 h-4 text-blue-600 border-gray-600 rounded focus:ring-blue-500"
                  />
