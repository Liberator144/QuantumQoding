...
class ContextIntegration extends EventEmitter {
  ...
  lintAndVerifyGuidelines(targetPath, options = {}) {
    try {
      ...
      // Combine results
      const combinedResult = this._combineResults(
        targetPath,
        lintResult,
        verificationResult,
        violations
      ...
      const baseGuidelines = {
        ...
        testing: {
          ...
          testAutomation: {
            required: true,
            description:
              'Automate all tests to ensure they can be run consistently and efficiently.',
          },
        },
      };
        ...
        return {
          ...
          structure: {
            directoryStructure: {
              required: true,
              description:
                'Place tests in the appropriate test directory that mirrors the src structure.',
            },
            fileOrganization: {
              required: true,
