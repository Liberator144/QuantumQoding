 ...
 */
export const setupDimensionalAPI = (app: Express) => {
  ...
  app.get(
    `${basePath}/boundaries/between/:sourceId/:targetId`,
    protect,
    dimensionalController.getBoundariesBetweenDimensions
  );
  ...
  app.put(
    `${basePath}/boundaries/:id/permissions`,
    protect,
    dimensionalController.updateBoundaryPermissions
  );
