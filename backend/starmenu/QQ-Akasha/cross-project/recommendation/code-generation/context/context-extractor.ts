...
export interface ContextExtractionOptions {
  ...
  /** Whether to detect code style */
  detectStyle?: boolean;

  /** Whether to detect naming conventions */
  detectNaming?: boolean;

  /** Whether to analyze scope */
  analyzeScope?: boolean;

  /** Whether to extract project context */
  extractProjectContext?: boolean;
 ...
 */
export const DEFAULT_EXTRACTION_OPTIONS: ContextExtractionOptions = {
  extractImports: true,
...
export async function extractContext(
  ...
  options: ContextExtractionOptions = DEFAULT_EXTRACTION_OPTIONS
): Promise<ContextExtractionResult> {
  const errors: string[] = [];
  const warnings: string[] = [];

  // Merge options with defaults
  const mergedOptions: ContextExtractionOptions = {
 ...
 * Extract project context
 */
async function extractProjectContext(filePath: string): Promise<ProjectContext> {
