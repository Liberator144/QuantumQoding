 ...
 */
export async function addSampleTemplates(repository: TemplateRepository): Promise<void> {
 ...
 * Add JavaScript/TypeScript templates
 */
async function addJavaScriptTemplates(repository: TemplateRepository): Promise<void> {
  // Class template
  const classTemplate: CodeTemplate = {
    id: uuidv4(),
...
export class ${className} {
  ...
  // Function template
  const functionTemplate: CodeTemplate = {
    id: uuidv4(),
...
export function ${functionName}(${functionParams}): ${returnType} {
  ...
  // Interface template
  const interfaceTemplate: CodeTemplate = {
    id: uuidv4(),
 ...
 * Add Python templates
 */
async function addPythonTemplates(repository: TemplateRepository): Promise<void> {
  // Python class template
  const pythonClassTemplate: CodeTemplate = {
    id: uuidv4(),
    name: 'Python Class',
 ...
 * Add HTML/CSS templates
 */
async function addWebTemplates(repository: TemplateRepository): Promise<void> {
  // HTML template
  const htmlTemplate: CodeTemplate = {
    id: uuidv4(),
    name: 'HTML Page',
